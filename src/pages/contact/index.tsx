...
import { AiFillAccountBook,AiFillFacebook,AiFillGoogleCircle,AiFillAmazonSquare } from "react-icons/ai";
  ...
  return (
    <div className="gap-3 flex justify-center items-center">
      ...
      <div className="  w-3/12  ml-3">
        {/* heading  */}
        <h2 className="text-3xl font-bold inline-block tracking-tight text-gray-500 mb-7 sm:text-4xl">
        ...
        <div className="mt-5">
         ...
         <div className="mt-10 flex justify-between items-center">
              ...
              <button className="hover:text-rose-500  ">
                     <AiFillAccountBook  size={40} />
              </button>  <button className="hover:text-rose-500  ">
                     <AiFillAccountBook  size={40} />
              </button>  <button className="hover:text-rose-500  ">
                     <AiFillAccountBook  size={40} />
              </button>  <button className="hover:text-rose-500  ">
        ...
        <div className="mt-10 font-medium text-gray-600">
          <p className="text-gray-500"><span className="font-bold text-[16px]">Monday - Friday:</span > 9:00 - 17:00</p>
          <p className="text-gray-500"><span className="font-bold text-[16px]">Monday - Friday:</span > 9:00 - 17:00</p><p className="text-gray-500"><span className="font-bold text-[16px]">Monday - Friday:</span > 9:00 - 17:00</p>
        </div>
      </div>
    </div>
  );
